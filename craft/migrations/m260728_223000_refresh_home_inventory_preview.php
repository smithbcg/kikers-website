...
/**
 * Refreshes the homepage thumbnails and the domain-aware AutoRecycler preview.
 */
class m260728_223000_refresh_home_inventory_preview extends Migration
{
    public function safeUp(): bool
    {
        ...
        foreach ($pages as $page) {
            if (!in_array($page->slug, ['home', 'u-pull-parts'], true)) {
                continue;
            }
